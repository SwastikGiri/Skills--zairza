      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div className={`items-center justify-between ${isMenuOpen ? 'flex' : 'hidden'} w-full md:flex md:w-auto md:order-1`} id="navbar-cta">
          <ul className="flex flex-col font-semibold text-lg md:p-0 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
            <li>
              <Link to="section2" spy={true} smooth={true} offset={-100} duration={0} className="nav-links block text-white rounded hover:bg-gray-900  md:bg-transparent cursor-pointer">Process</Link>
            </li>
            <li>
              <Link to="section3" spy={true} smooth={true} offset={-150} duration={0} className="nav-links block text-white rounded hover:bg-gray-900  md:bg-transparent cursor-pointer">Timeline</Link>
            </li>
            <li>
              <Link to="section4" spy={true} smooth={true} offset={-150} duration={0} className="nav-links block text-white rounded hover:bg-gray-900  md:bg-transparent cursor-pointer">Perks</Link>
            </li>
            <li>
              <Link to="section5" spy={true} smooth={true} offset={-150} duration={0} className="nav-links block text-white rounded hover:bg-gray-900  md:bg-transparent cursor-pointer">Explore Domains</Link>
            </li>
          </ul>
        </div>
      </div>
